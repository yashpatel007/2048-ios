...
protocol AppearanceProtol:class {
    func tileColor(value:Int)->UIColor
    func numberColor(value:Int)->UIColor
    func fontForNumbers()->UIFont
}

class Appearance: AppearanceProtol{
    
    
    func tileColor(value: Int) -> UIColor {
        switch value {
        case 2:
            // here we can change the color of tile as we like// the perticular color is for the tole numbered 2
        ...
        case 8:
            // here we can change the color of tile as we like// the perticular color is for the tole numbered 2
            return UIColor(red:242.0/255.0,green:117.0/255.0,blue:121.0/255.0,alpha: 1.0 )
        case 16:
            // here we can change the color of tile as we like// the perticular color is for the tole numbered 2
            return UIColor(red:245.0/255.0,green:149.0/255.0,blue:99.0/255.0,alpha: 1.0 )
        case 32:
            // here we can change the color of tile as we like// the perticular color is for the tole numbered 2
            return UIColor(red:246.0/255.0,green:124.0/255.0,blue:99.0/255.0,alpha: 1.0 )
        case 64:
            // here we can change the color of tile as we like// the perticular color is for the tole numbered 2
            return UIColor(red:246.0/255.0,green:94.0/255.0,blue:59.0/255.0,alpha: 1.0 )
        case 128,256,512,1024,2018 :
            // here we can change the color of tile as we like// the perticular color is for the tole numbered 2
    ...
    func fontForNumbers() -> UIFont {
        ...
        {return font}
        return UIFont.systemFontSize(20)
    }
}
